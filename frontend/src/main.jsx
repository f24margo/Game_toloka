...
const hints = {
  "ліс":{"синонім":"гай, пуща","антонім":"поле, степ","асоціація":"дерева, тиша"},
  "вода":{"синонім":"волога, рідина","антонім":"вогонь, суша","асоціація":"річка, море"},
  "вітер":{"синонім":"буря, хуртовина","антонім":"штиль, тиша","асоціація":"хмари, холод"},
  "сонце":{"синонім":"світило, зоря","антонім":"темрява, ніч","асоціація":"тепло, літо"},
  "хмара":{"синонім":"туча, хмарина","антонім":"сонце, ясність","асоціація":"дощ, небо"},
  "земля":{"синонім":"грунт, ґрунт","антонім":"небо, повітря","асоціація":"поле, родина"},
  "річка":{"синонім":"потік, струмок","антонім":"гора, суша","асоціація":"вода, риба"},
  "гора":{"синонім":"пагорб, вершина","антонім":"долина, низина","асоціація":"сніг, висота"},
  "радість":{"синонім":"щастя, веселість","антонім":"смуток, горе","асоціація":"сміх, свято"},
  "смуток":{"синонім":"сум, туга","антонім":"радість, веселість","асоціація":"сльози, дощ"},
  "любов":{"синонім":"кохання, ніжність","антонім":"ненависть, злоба","асоціація":"серце, тепло"},
  "місто":{"синонім":"мегаполіс, поселення","антонім":"село, ліс","асоціація":"вулиці, люди"},
  "стіл":{"синонім":"столик, поверхня","антонім":"підлога, земля","асоціація":"їжа, робота"},
  "хліб":{"синонім":"паляниця, хлібина","антонім":"голод, порожнеча","асоціація":"їжа, дім"}
};
...
window.getHint = () => {
  ...
  const hint = wordHints ? wordHints[rounds[round]] : "Подумай уважніше!";
  document.getElementById("fb").innerHTML = `<span style="color:#185FA5">💡 ${hint}</span>`;
};
